...
APP_PKG="$ROOT/HohohSolutions-CRM-v1.0.0.pkg"
APP_DMG="$ROOT/HohohSolutions-CRM-v1.0.0.dmg"
NATIVE_APP="$ROOT/HohohSolutions CRM Native.app"
WEB_DIST="$ROOT/webapp/dist"
VITRINE_HTML="$ROOT/hohohsolutions-website.html"
